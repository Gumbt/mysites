                        ...
                        <div class="body">						
							...
							<div class="row clearfix">
								...
								<div class="col-sm-6">
									<div class="form-group form-float">
										<div class="form-line">
											<input name="cpf" type="text" class="form-control" pattern="[0-9]{11}" required>
							...
							<div class="row clearfix">
								...
								<div class="col-sm-4">
									<div class="form-group form-float">
										<div class="form-line">
											<input name="cep" type="number" class="form-control" pattern="[0-9]{8}" required>
							...
							<div class="row clearfix">
								<div class="col-sm-4">
									...
									<div class="input-group">
										...
										<div class="form-line">
											<input name="email" type="email" class="form-control email" placeholder="Ex: example@example.com" required>
										</div>
									</div>
								</div>
								<div class="col-sm-4">
									...
									<div class="input-group">
										...
										<div class="form-line">
											<input name="datanasc" type="date" class="form-control date" placeholder="Ex: 30/07/2016" required>
										</div>
									</div>
								</div>
								<div class="col-sm-4">
                        ...
                        <div class="body">
							...
							<div class="row clearfix">
								<div class="col-sm-4">
									...
									<div class="form-group form-float">
										<div class="form-line">
											<input name="user" type="text" class="form-control" placeholder="Login" required>
										</div>
									</div>
								</div>
								<div class="col-sm-4">
...
$(document).ready(function(){
        ...
        swal({
			title: "Salvar informações do funcionário?",
