...
<body class="theme-red">
    ...
    <section class="content">
        <div class="container-fluid">
           ...
           <!-- cadastro -->
			<form id="sign_in" class="cadastroForm" method="POST" action="funcoes/update">		   
                        ...
                        <div class="body">							
								...
								<div class="row clearfix">
									<div class="col-sm-6">
										<div class="form-group form-float">
											<div class="form-line">
												<input name="nome" type="text" class="form-control" value="<?php echo $nomeuser; ?>" required>
									...
									<div class="col-sm-6">
										<div class="form-group form-float">
											<div class="form-line">
												<input name="cpf" type="number" class="form-control" value="<?php echo $cpf; ?>" pattern="[0-9]{11}"  required>
								...
								<div class="row clearfix">
									...
									<div class="col-sm-4">
										<div class="form-group form-float">
											<div class="form-line">
												<input name="cep" type="number" class="form-control" value="<?php echo $cep; ?>" pattern="[0-9]{8}" required>
									...
									<div class="col-sm-4">
										<div class="form-group form-float">
											<div class="form-line">
												<input name="telefone" type="text" class="form-control" value="<?php echo $telefone; ?>"  required>
								...
								<div class="row clearfix">
									<div class="col-sm-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input name="email" type="email" class="form-control email" value="<?php echo $email; ?>"  required>
                                            </div>
                                        </div>
									</div>
									<div class="col-sm-4">
										...
										<div class="input-group">
											...
											<div class="form-line">
												<input name="datanasc" type="date" class="form-control date" value="<?php echo $data_nasc; ?>"  required>
											</div>
										</div>
									</div>
									<div class="col-sm-4">
							...
							<div class="row clearfix">
								...
								<div class="col-sm-4">
									<div class="form-group form-float">
										<b>Senha</b>
										<div class="form-line">
											<input name="senha" type="password" class="form-control" value="<?php echo $senhauser; ?>" required>
										</div>
									</div>
								</div>
								<div class="col-sm-4">
								...
								<a href="perfil?id=<?php echo $iduser; ?>" class="btn bg-orange waves-effect">VOLTAR</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        swal({
			...
			$.post(ajaxUrl, formData, function(data){
				...
				swal({
						...
						window.location.href = 'perfil?id='+data.iduser;
					});
				}else{
