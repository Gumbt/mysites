                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
							...
							<button type="button" class="btn btn-danger waves-effect excluirbtn" value="<?php echo $iduser; ?>" name="<?php echo $nomeuser; ?>">EXCLUIR</button>
...
$(document).ready(function(){
		$(".excluirbtn").click(function(){
			...
			swal({
				title: "Excluir informações do fundionario " + nomefuncionario + "?",
