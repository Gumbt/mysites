           ...
           <!-- cadastro -->
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<form id="sign_in" class="cadastroForm" method="POST" action="funcoes/update" enctype="multipart/form-data">
                    <div class="card">
                        <div class="header">
                            <h2>Editar produto</h2>
                        </div>
							...
							<div class="body">							
								<div class="row clearfix">
								<input name="idproduto" type="hidden" class="form-control" value="<?php echo $idproduto; ?>">
									<div class="col-sm-6">
										<div class="form-group form-float">
											<div class="form-line">
												<input name="nome" type="text" class="form-control" value="<?php echo $nomeproduto; ?>" required>
									...
									<div class="col-sm-6">
										<div class="form-group form-float">
											<div class="form-line">
												<input name="preco" type="number" class="form-control" value="<?php echo $preco; ?>" step="any" min="0" required>
								...
								<div class="row clearfix">
									<div class="col-sm-4">
										<div class="form-group form-float">
											<div class="form-line">
												<input name="marca" type="text" class="form-control" value="<?php echo $marca; ?>" required>
									...
									<div class="col-sm-4">
										<div class="form-group form-float">
											<div class="form-line">
												<input name="fornecedor" type="text" class="form-control" value="<?php echo $fornecedor; ?>" required>
									...
									<div class="col-sm-4">
										<div class="form-group form-float">
											<div class="form-line">
												<input name="modelo" type="text" class="form-control" value="<?php echo $modelo; ?>" required>
								...
								<div class="row clearfix">
									<div class="col-sm-12">
										<div class="form-group">
											<div class="form-line">
												<textarea rows="4" name="descricao" class="form-control no-resize" placeholder="Descrição"><?php echo $descricao; ?></textarea>
											</div>
										</div>
									</div>
								</div>
					...
					<input type="hidden" class="contelements" name="contelements" value="<?php echo $totalrow; ?>">	
					<input type="hidden" class="contnext" name="contnext" value="<?php echo $totalrow; ?>">					
					<div class="card" id="unidadesdiv1">
						...
						{
						?>
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 cardrmv<?php echo $cont; ?>"><div class="card"><div class="header <?php echo $row["cor"]; ?>"><h2>Cor: <?php echo $row["cor"]; ?></h2></div><div class="body"><input type="hidden" name="cor[]" value="<?php echo $row["cor"]; ?>"><input type="hidden" name="tamanho[]" value="<?php echo $row["tamanho"]; ?>"><input type="hidden" name="unidades[]" value="<?php echo $row["unidades"]; ?>"><div class="list-group"><a href="javascript:void(0);" class="list-group-item"><span class="badge" style="font-size: 15px;"><?php echo $row["tamanho"]; ?></span> Tamanho:</a><a href="javascript:void(0);" class="list-group-item"><span class="badge" style="font-size: 15px;"><?php echo $row["unidades"]; ?></span>Unidades:</a></div><button type="button" class="btn bg-red btn-block btn-sm waves-effect excluirbtn" value="<?php echo $cont; ?>" name="remover">REMOVER</button></div></div></div>
						<?php $cont++;
						}
						Database::disconnect();	
						?>
						...
						<div class="card">
							...
							<a href="produto?id=<?php echo $idproduto; ?>" class="btn bg-orange waves-effect">VOLTAR</a>
							</div>		
						</div>
					</form>
                </div>
