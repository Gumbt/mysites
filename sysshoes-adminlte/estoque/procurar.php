					...
					<div class="row filterdiv">
						...
						?>
                                <div class="col-sm-6 col-md-3 post" style="display:none" data-price="<?php echo $row["preco"]; ?>">
                                    <div class="thumbnail">
                                        <a href="produto?id=<?php echo $row["id_produto"]; ?>"><div class="corespesquisar"><span style="float:left">Cores:</span> <?php 
											...
											?></div><img src="<?php if($row["foto"]=="0"){echo 'images/tenis.png';}else{echo 'images/'.$row["id_produto"].$row["foto"];} ?>" style="height: 150px!important;"></a>
                                        <div class="caption" style="border-top: 1px solid #cecece;margin-top: 2px;">
                                            ...
                                            <div class="buttondescritt">
                                                <a href="produto?id=<?php echo $row["id_produto"]; ?>" class="btn btn-primary waves-effect" role="button">VER</a>
												<a href="editar?id=<?php echo $row["id_produto"]; ?>" class="btn btn-success waves-effect" role="button">EDITAR</a>
												<button type="button" class="btn btn-danger waves-effect excluirbtn" value="<?php echo $row["id_produto"]; ?>" name="<?php echo $row["nome"]; ?>">EXCLUIR</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
