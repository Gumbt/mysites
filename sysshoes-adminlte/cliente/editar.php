                    ...
                    <div class="card">
                        ...
                        <div class="body">
							<form id="sign_in" class="cadastroForm" method="POST" action="funcoes/update">
								...
								<input name="idcliente" type="hidden" class="form-control" value="<?php echo $iduser; ?>">
								<div class="row clearfix">
									<div class="col-sm-6">
										<div class="form-group form-float">
											<div class="form-line">
												<input name="nome" type="text" class="form-control" value="<?php echo $nomecliente; ?>" required>
