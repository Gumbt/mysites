                    ...
                    <div class="card">
                        ...
                        <div class="body">
							<form id="sign_in" class="cadastroForm" method="POST" action="funcoes/inserir">
								...
								<div class="row clearfix">
									<div class="col-sm-6">
										<div class="form-group form-float">
											<div class="form-line">
												<input name="nome" type="text" class="form-control" value="<?php echo $nomecliente; ?>" disabled>
								...
								<a href="editar?id=<?php echo $iduser; ?>" class="btn bg-brown waves-effect">EDITAR</a>
								<button type="button" class="btn btn-danger waves-effect excluirbtn" value="<?php echo $iduser; ?>" name="<?php echo $nomecliente; ?>">EXCLUIR</button>
