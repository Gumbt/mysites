                                ...
                                <table id="example" class="table table-bordered table-striped table-hover js-basic-example dataTable">
									...
									?>
										<tr style="cursor:pointer;" class="idpicker">
											<td class="thisid" data-href='perfil?id=<?php echo $row["id_cliente"]; ?>'><?php echo $row["nome"]; ?></td>
											<td class="thisid" data-href='perfil?id=<?php echo $row["id_cliente"]; ?>'><?php echo $row["cpf"]; ?></td>                                         
											<td class="thisid" data-href='perfil?id=<?php echo $row["id_cliente"]; ?>'><?php echo $row["cep"]; ?></td>
											<td class="thisid" data-href='perfil?id=<?php echo $row["id_cliente"]; ?>'><?php echo $row["telefone"]; ?></td>
											<td style="text-align:center!important;"><div class="btn-group" role="group" aria-label="Second group">
													<a href="editar?id=<?php echo $row["id_cliente"]; ?>" class="btn btn-success waves-effect">Editar</a>
													<button type="button" class="btn btn-danger waves-effect excluirbtn" value="<?php echo $row["id_cliente"]; ?>" name="<?php echo $row["nome"]; ?>">Excluir</button>
												</div>
											</td>
										</tr>
									<?php } 
...
$(document).ready(function(){
		...
		$("#example").on('click','.excluirbtn',function () {
			...
			var nomecliente = $(this).attr('name');
			swal({
				title: "Excluir informações do cliente " + nomecliente + "?",
				...
				$.post(ajaxUrl, { idcliente: idcliente}, function(data){
