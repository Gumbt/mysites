...
<script>
  ...
  gtag('config', 'UA-96323024-3');
		...
		<script src="js/my.js?version=1"></script>
			...
			<section id="main" class="wrapper" style="padding:8em 0em 1em">
				<div class="container">
					...
					<h4>Clans da família Psicowar:</h4>
						<a href="psicowar"><div class="nossosclans2 button <?php if($t!="2LULCGP8"){echo "alt";} ?>">Psicowar</div></a>
						<a href="psicoreborn"><div class="nossosclans2 button <?php if($t!="C08PQC9G"){echo "alt";} ?>">PSICO REBORN</div></a>
						<a href="ligademetal"><div class="nossosclans2 button <?php if($t!="8UVPYCGL"){echo "alt";} ?>">LIGA DE METAL</div></a>
						<a href="dinastiacla"><div class="nossosclans2 button <?php if($t!="2YGL80CY"){echo "alt";} ?>">Dinastia Clã</div></a>
						<a href="cacadores"><div class="nossosclans2 button <?php if($t!="9LP8YJLY"){echo "alt";} ?>">Caçadores</div></a>
						
						<a href="skillbruta"><div class="nossosclans2 button <?php if($t!="POPVOV28"){echo "alt";} ?>">SKILLBRUTA</div></a>
						<a href="furiatopteam"><div class="nossosclans2 button <?php if($t!="PLO8Q8O"){echo "alt";} ?>">Fúria Topteam</div></a>
					</div>
					<div style="width:100%">
